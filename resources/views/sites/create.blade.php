...
@section('header', 'Create New Site')
@section('description', 'Add a new network site location')

@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-medium text-gray-900">Site Details</h3>
                <p class="text-sm text-gray-600">Fill in the information about the network site</p>
            </div>

            <form action="{{ route('sites.store') }}" method="POST" class="p-6 space-y-6" id="siteForm">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="site_id" id="site_id" value="{{ old('site_id') }}"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        ...
                        placeholder="Enter site description (optional)">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
    ...
    <div id="loadingOverlay" 
        ...
        <div class="bg-white rounded-lg p-8 max-w-md mx-4 text-center shadow-2xl">
            <div class="flex flex-col items-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Creating Site...</h3>
